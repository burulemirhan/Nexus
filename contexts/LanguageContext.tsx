...
export const LanguageProvider: React.FC<LanguageProviderProps> = ({ children, defaultLanguage }) => {
  ...
  const translations: Record<Language, Record<string, string>> = {
    tr: {
      ...
      'tech.ai.title': 'Çok Modlu Akıllı Düzenleme Ajanı - MIRA',
      'tech.ai.intro': 'Sensor verisi + Görsel/IR bitki geri bildirimiyle, ortamı "takvime göre" değil bitkinin tepkisine göre yöneten otonom kontrol katmanı.',
      'tech.ai.shortDesc': 'Nexus AI Agent, iklim odası / growth chamber içinde bitkiyi sürekli izler, stres ve büyüme sinyallerini yorumlar ve ışık, VPD, CO2, sulama-gübreleme gibi değişkenleri güvenli sınırlar içinde anlık optimize eder. Amaç: operatör bağımlılığı olmadan; daha yüksek uniformite, daha tutarlı kalite, ve en önemlisi daha az enerji tüketimi.',
      'tech.ai.layer1.title': 'Multimodal Algı (Sensors + Vision/IR)',
      'tech.ai.layer1.desc': 'Gerçek zamanlı ortam sensörleri + RGB/termal görüntü akışı. Bitkiyi "ölçülen ortam" değil, gözlenen organizma olarak okur.',
      'tech.ai.layer2.title': 'Bitki Durumu Modeli (Plant-State Intelligence)',
      'tech.ai.layer2.desc': 'Büyüme hızı, turgu/stres imzaları, yaprak sıcaklığı, renk-doku değişimleri gibi sinyallerden bitkinin anlık durumunu çıkarır.',
      'tech.ai.layer3.title': 'Otonom Kontrol Döngüsü (Gözlemle -> Karar ver -> Hareket et -> Doğrula)',
      'tech.ai.layer3.desc': 'Agent, hedef kalite/verim parametrelerine göre setpoint\'leri dinamik ayarlar ve her aksiyonu geri beslemeyle doğrular.',
      'tech.ai.layer4.title': 'Verim / Kalite Optimizasyonu',
      'tech.ai.layer4.desc': 'Enerji-verim dengesi, uniformite, hasat tutarlılığı. Tüm kararlar donanım ve biyoloji için güvenlik sınırları içinde çalışır; gerektiğinde insan onayıyla.',
      'tech.ai.tagline': 'Bitki konuşur. Sistem dinler. Ortam cevap verir.',
    ...
    en: {
      ...
      'tech.ai.title': 'Multimodal Intelligent Regulation Agent - MIRA',
      'tech.ai.intro': 'An autonomous control layer that manages the environment based on plant response rather than calendar, using sensor data + visual/IR plant feedback.',
      'tech.ai.shortDesc': 'Nexus AI Agent continuously monitors plants within climate chambers / growth chambers, interprets stress and growth signals, and optimizes variables such as light, VPD, CO2, irrigation-fertilization in real-time within safe limits. Goal: without operator dependency; higher uniformity, more consistent quality, and most importantly, lower energy consumption.',
      'tech.ai.layer1.title': 'Multimodal Sensing (Sensors + Vision/IR)',
      'tech.ai.layer1.desc': 'Real-time environmental sensors + RGB/thermal image stream. Reads the plant not as "measured environment" but as an observed organism.',
      'tech.ai.layer2.title': 'Plant State Model (Plant-State Intelligence)',
      'tech.ai.layer2.desc': 'Extracts the plant\'s real-time state from signals such as growth rate, turgor/stress signatures, leaf temperature, color-texture changes.',
      'tech.ai.layer3.title': 'Autonomous Control Loop (Observe -> Decide -> Act -> Verify)',
      'tech.ai.layer3.desc': 'The agent dynamically adjusts setpoints according to target quality/yield parameters and verifies each action through feedback.',
      'tech.ai.layer4.title': 'Yield / Quality Optimization',
      'tech.ai.layer4.desc': 'Energy-yield balance, uniformity, harvest consistency. All decisions operate within safety limits for hardware and biology; with human approval when necessary.',
      'tech.ai.tagline': 'The plant speaks. The system listens. The environment responds.',
