...
export const LanguageProvider: React.FC<LanguageProviderProps> = ({ children, defaultLanguage }) => {
  ...
  const translations: Record<Language, Record<string, string>> = {
    tr: {
      ...
      'tech.hardware.title': 'Donanım Platformları',
      'tech.terra.name': 'TERRA',
      'tech.terra.subtitle': 'Arazi Sistemleri',
      'tech.aether.name': 'AETHER',
      'tech.aether.subtitle': 'Enerji ve Foton Sistemleri',
      'tech.oasis.name': 'OASIS',
      'tech.oasis.subtitle': 'Sürekli Yetiştirme Sistemleri',
      'tech.intelligence.title': 'Nexus Intelligence',
      'tech.intelligence.description': 'Farklı ortamlarda ürünleri yöneten birleşik yapay zeka katmanı',
      'tech.intelligence.modules': 'Modüller:',
      'tech.intelligence.module1': 'Ürün Durum Zekası',
    ...
    en: {
      ...
      'tech.terra.name': 'TERRA',
      'tech.terra.subtitle': 'Field Systems',
      'tech.aether.name': 'AETHER',
      'tech.aether.subtitle': 'Energy & Photon Systems',
      'tech.oasis.name': 'OASIS',
      'tech.oasis.subtitle': 'Continuous Cultivation Systems',
      'tech.intelligence.title': 'Nexus Intelligence',
      'tech.intelligence.description': 'A unified AI layer operating crops across environments',
